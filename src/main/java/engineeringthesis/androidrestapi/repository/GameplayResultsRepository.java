...
public interface GameplayResultsRepository extends JpaRepository<GameplayResultEntity,Integer> {
	...
	List<GameplayResultEntity>getAllUserResultsByGuestId(@Param("guestUUID") String guestUUID);
	...
	List<GameplayResultEntity>getAllUserResultsByGameName(@Param("gameName") String gameName);
